...
// SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-interfaces/interface/subinterface/bridge-table/mac-learning/learnt-entries/mac/aging within the YANG schema.
type SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface {
	Is_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union()
}

// SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging is used when /srl_nokia-interfaces/interface/subinterface/bridge-table/mac-learning/learnt-entries/mac/aging
// is to be set to a E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging value.
type SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging struct {
	E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging
// implements the SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface.
func (*SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging) Is_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union() {
}

// SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64 is used when /srl_nokia-interfaces/interface/subinterface/bridge-table/mac-learning/learnt-entries/mac/aging
// is to be set to a uint64 value.
type SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64 struct {
	Uint64 uint64
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64
// implements the SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface.
func (*SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64) Is_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union() {
}

// To_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac) To_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union(i interface{}) (SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging:
		return &SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging{v}, nil
	case uint64:
		return &SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union, unknown union type, got: %T, want any of [E_SrlNokiaInterfaces_Interface_Subinterface_BridgeTable_MacLearning_LearntEntries_Mac_Aging, uint64]", i, i)
	}
}
...
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union interface {
	Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union()
}

// SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime is used when /srl_nokia-interfaces/interface/subinterface/ipv6/router-advertisement/router-role/prefix/preferred-lifetime
// is to be set to a E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime value.
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime struct {
	E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime
...
func (*SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime) Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union() {
}

// SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_Uint32 is used when /srl_nokia-interfaces/interface/subinterface/ipv6/router-advertisement/router-role/prefix/preferred-lifetime
// is to be set to a uint32 value.
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_Uint32 struct {
	Uint32 uint32
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_Uint32
// implements the SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union interface.
func (*SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_Uint32) Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union() {
}
...
// cannot be converted to a type within the union.
func (t *SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix) To_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union(i interface{}) (SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime:
		return &SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime{v}, nil
	case uint32:
		return &SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime_Union, unknown union type, got: %T, want any of [E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_PreferredLifetime, uint32]", i, i)
	}
}
...
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union interface {
	Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union()
}

// SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime is used when /srl_nokia-interfaces/interface/subinterface/ipv6/router-advertisement/router-role/prefix/valid-lifetime
// is to be set to a E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime value.
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime struct {
	E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime
...
func (*SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime) Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union() {
}

// SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_Uint32 is used when /srl_nokia-interfaces/interface/subinterface/ipv6/router-advertisement/router-role/prefix/valid-lifetime
// is to be set to a uint32 value.
type SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_Uint32 struct {
	Uint32 uint32
}

// Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union ensures that SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_Uint32
// implements the SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union interface.
func (*SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_Uint32) Is_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union() {
}
...
// cannot be converted to a type within the union.
func (t *SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix) To_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union(i interface{}) (SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime:
		return &SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime{v}, nil
	case uint32:
		return &SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime_Union, unknown union type, got: %T, want any of [E_SrlNokiaInterfaces_Interface_Subinterface_Ipv6_RouterAdvertisement_RouterRole_Prefix_ValidLifetime, uint32]", i, i)
	}
}
...
// SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/bridge-table/mac-learning/learnt-entries/mac/aging within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging is used when /srl_nokia-network-instance/network-instance/bridge-table/mac-learning/learnt-entries/mac/aging
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging value.
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging struct {
	E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging
// implements the SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging) Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64 is used when /srl_nokia-network-instance/network-instance/bridge-table/mac-learning/learnt-entries/mac/aging
// is to be set to a uint64 value.
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64 struct {
	Uint64 uint64
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64
// implements the SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64) Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac) To_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging:
		return &SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging{v}, nil
	case uint64:
		return &SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union_Uint64{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_MacLearning_LearntEntries_Mac_Aging, uint64]", i, i)
	}
}
...
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination is used when /srl_nokia-network-instance/network-instance/bridge-table/static-mac/mac/destination
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination value.
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination struct {
	E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination
// implements the SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination) Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_String is used when /srl_nokia-network-instance/network-instance/bridge-table/static-mac/mac/destination
// is to be set to a string value.
type SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_String struct {
	String string
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_String
// implements the SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_String) Is_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union() {
}
...
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac) To_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination:
		return &SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination{v}, nil
	case string:
		return &SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union_String{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_BridgeTable_StaticMac_Mac_Destination, string]", i, i)
	}
}
...
// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/isis/instance/interface/adjacency/neighbor-last-restart within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart is used when /srl_nokia-network-instance/network-instance/protocols/isis/instance/interface/adjacency/neighbor-last-restart
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart struct {
	E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_String is used when /srl_nokia-network-instance/network-instance/protocols/isis/instance/interface/adjacency/neighbor-last-restart
// is to be set to a string value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_String struct {
	String string
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_String
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_String) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart{v}, nil
	case string:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union_String{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Isis_Instance_Interface_Adjacency_NeighborLastRestart, string]", i, i)
	}
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/extended-link/link-data within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/extended-link/link-data
// is to be set to a string value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String struct {
	String string
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32 is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/extended-link/link-data
// is to be set to a uint32 value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32 struct {
	Uint32 uint32
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union, error) {
	switch v := i.(type) {
	case string:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String{v}, nil
	case uint32:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union, unknown union type, got: %T, want any of [string, uint32]", i, i)
	}
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type struct {
...
// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/interface/link-local-lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type
// is to be set to a E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES struct {
	E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type{v}, nil
	case E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type, E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES]", i, i)
	}
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/extended-link/link-data within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/extended-link/link-data
// is to be set to a string value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String struct {
	String string
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32 is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/extended-link/link-data
// is to be set to a uint32 value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32 struct {
	Uint32 uint32
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union, error) {
	switch v := i.(type) {
	case string:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_String{v}, nil
	case uint32:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_ExtendedLink_LinkData_Union, unknown union type, got: %T, want any of [string, uint32]", i, i)
	}
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type struct {
	E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/opaque-lsa/router-information/tlvs/tlv/type
// is to be set to a E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES struct {
	E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type{v}, nil
	case E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union_E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Interface_LinkLocalLsas_Lsa_OpaqueLsa_RouterInformation_Tlvs_Tlv_Type, E_SrlNokiaOspfTypes_RI_LSA_TLV_TYPES]", i, i)
	}
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union is an interface that is implemented by valid types for the union
// for the leaf /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/router-lsa/links/link-data within the YANG schema.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_String is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/router-lsa/links/link-data
// is to be set to a string value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_String struct {
	String string
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_String
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_String) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_Uint32 is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/area/lsdb/lsa-types/lsa-type/lsas/lsa/router-lsa/links/link-data
// is to be set to a uint32 value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_Uint32 struct {
	Uint32 uint32
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_Uint32
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_Uint32) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union() {
}

// To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union takes an input interface{} and attempts to convert it to a struct
// which implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union union. It returns an error if the interface{} supplied
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union, error) {
	switch v := i.(type) {
	case string:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_String{v}, nil
	case uint32:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union_Uint32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Area_Lsdb_LsaTypes_LsaType_Lsas_Lsa_RouterLsa_Links_LinkData_Union, unknown union type, got: %T, want any of [string, uint32]", i, i)
	}
}
...
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union interface {
	Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union()
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/asbr/trace-path
// is to be set to a E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath struct {
	E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union() {
}

// SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_Int32 is used when /srl_nokia-network-instance/network-instance/protocols/ospf/instance/asbr/trace-path
// is to be set to a int32 value.
type SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_Int32 struct {
	Int32 int32
}

// Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union ensures that SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_Int32
// implements the SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union interface.
func (*SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_Int32) Is_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union() {
}
...
// cannot be converted to a type within the union.
func (t *SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr) To_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union(i interface{}) (SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union, error) {
	switch v := i.(type) {
	case E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath{v}, nil
	case int32:
		return &SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union_Int32{v}, nil
	default:
		return nil, fmt.Errorf("cannot convert %v to SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath_Union, unknown union type, got: %T, want any of [E_SrlNokiaNetworkInstance_NetworkInstance_Protocols_Ospf_Instance_Asbr_TracePath, int32]", i, i)
	}
}
